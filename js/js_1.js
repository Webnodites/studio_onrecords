...
CloudflareApps.installs["1ECLO69xw6Lu"] = { appId: "nt4L5NPJq1za", scope: {} };
CloudflareApps.installs["1ECLO69xw6Lu"].options = {
  blocks: [
    {
      code:
      ...
      location: { method: "append", selector: "body" }
    },
    { code: "", location: { method: "append", selector: "head" } }
  ]
};
CloudflareApps.installs["1ECLO69xw6Lu"].selectors = {
  "blocks[0].location.selector": "body",
  "blocks[1].location.selector": "head"
};
CloudflareApps.installs["DyHT7OEIbHOI"] = { appId: "nGAnsTeiPCQx", scope: {} };
CloudflareApps.installs["DyHT7OEIbHOI"].options = {
  subdomain_tracker_ids: [{ subdomain: "", tracker_id: "" }],
  tracker_id: "UA-38030533-1"
};
CloudflareApps.installs["DyHT7OEIbHOI"].product = {
  id: "google-analytics-free"
};
CloudflareApps.installs["Gja7vEoCkvPD"] = { appId: "XzVIEqe1R2kW", scope: {} };
...
if (
  CloudflareApps.matchPage(CloudflareApps.installs["1ECLO69xw6Lu"].URLPatterns)
) {
  (function () {
    "use strict";
      ...
      options.blocks.forEach(function (block, index) {
        ...
        if (elements[locationHash]) {
          ...
          if (block.location.method === "replace") {
            prevElements[locationHash] = document.querySelector(
              block.location.selector
            );
          }
      ...
      for (var hash in elements) {
        if (!elements[hash].foundInBlocks) {
          if (prevElements[hash]) {
            elements[hash].parentNode.replaceChild(
              prevElements[hash],
              elements[hash]
            );
    ...
    window.CloudflareApps.installs["1ECLO69xw6Lu"].scope = {
...
(function () {
  ...
  script.src = "/cdn-cgi/apps/body/_DPJDACzCh_ZdoTN9-DzOFjxAdM.js";
